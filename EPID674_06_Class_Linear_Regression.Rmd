...
model_0 <- tbl_regression(lm(m0, na.action = na.omit, data = nhanes_dataset))
model_1 <- tbl_regression(lm(m1, na.action = na.omit, data = nhanes_dataset))
model_2 <- tbl_regression(lm(m2, na.action = na.omit, data = nhanes_dataset),
                          label = race_eth ~ "Race/Ethnicity")
model_3 <- tbl_regression(lm(m3, na.action = na.omit, data = nhanes_dataset),
                          label = race_eth ~ "Race/Ethnicity")
model_4 <- tbl_regression(lm(m4, na.action = na.omit, data = nhanes_dataset),
                          label = race_eth ~ "Race/Ethnicity")
