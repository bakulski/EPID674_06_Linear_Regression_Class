...
# directory <- "/Volumes/GoogleDrive/My Drive/Teaching/EPID674/2020_fall/EPID674_Week6_Class/" # Alternate option 2: location of data on my Macbook
...
reg_output <- Test(test.var, nhanes$sbp, nhanes$age) # Run the function
write.csv(reg_output, file = paste0(directory, "sbp.results.csv")) # Look in your output directory for the beta coefficients and p-values for all covariates! 
```
