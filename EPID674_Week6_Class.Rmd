...
write.csv(reg_output, file = here("sbp.results.csv")) # Look in your output directory for the beta coefficients and p-values for all covariates! 
```
